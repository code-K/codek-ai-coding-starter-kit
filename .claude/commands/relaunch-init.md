...
Lies JETZT in dieser Reihenfolge — beide Dateien sind verbindlich:
1. `.agents/skills/relaunch-init/SKILL.md` — der orchestrierte Init-Flow
   (Phase 1–7, Approval-Gate, Handoff). Diese Skill ist auch für andere
   Agents im `.agents`-Framework verfügbar.
2. `docs/RECIPE-Website-Relaunch.md` — die binding Playbook mit allen
   Build-Details für Stage 3+.
